        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-red-400 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-500 transition-colors duration-300 rounded text-lg shadow-md">
                  Send Message
                </button>
              </div>
            </div>
